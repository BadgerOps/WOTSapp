    ...
    <footer className="fixed bottom-0 left-0 right-0 z-40">
      <div className="bg-gray-800 text-gray-300 py-2 px-4 text-xs">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link to="/changelog" className="text-gray-500 hover:text-gray-300 transition-colors">WOTS App v{APP_VERSION}</Link>
          <span className="text-red-500 font-semibold">
            NOTE: THIS IS NOT AN OFFICIAL WOTS Application, this is a candidate
            led app
          </span>
