...
**IMPORTANT: Always use `nix develop` for Node.js CLI commands in this repo.**

```bash
# Enter the dev shell before running any node/npm commands
nix develop
...
- Node.js 22 LTS (pinned via flake.lock for reproducibility)
